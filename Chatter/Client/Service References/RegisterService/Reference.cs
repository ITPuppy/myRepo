...
namespace Client.RegisterService {
    ...
    [System.Runtime.Serialization.KnownTypeAttribute(typeof(Client.RegisterService.Member))]
    ...
    [System.SerializableAttribute()]
    public partial class Member : Client.RegisterService.BaseRole {
        ...
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private Client.RegisterService.MemberStatus statusField;
        ...
        [System.Runtime.Serialization.DataMemberAttribute()]
        public Client.RegisterService.MemberStatus status {
            get {
    ...
    public interface IRegister {
        ...
        Client.RegisterService.Member Register(Client.RegisterService.Member member);
        ...
        System.IAsyncResult BeginRegister(Client.RegisterService.Member member, System.AsyncCallback callback, object asyncState);
        
        Client.RegisterService.Member EndRegister(System.IAsyncResult result);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IRegisterChannel : Client.RegisterService.IRegister, System.ServiceModel.IClientChannel {
    }
    ...
    public partial class RegisterCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        ...
        public Client.RegisterService.Member Result {
            get {
                base.RaiseExceptionIfNecessary();
                return ((Client.RegisterService.Member)(this.results[0]));
            }
        }
    }
    ...
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class RegisterClient : System.ServiceModel.ClientBase<Client.RegisterService.IRegister>, Client.RegisterService.IRegister {
        ...
        public Client.RegisterService.Member Register(Client.RegisterService.Member member) {
            return base.Channel.Register(member);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        public System.IAsyncResult BeginRegister(Client.RegisterService.Member member, System.AsyncCallback callback, object asyncState) {
            return base.Channel.BeginRegister(member, callback, asyncState);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        public Client.RegisterService.Member EndRegister(System.IAsyncResult result) {
            return base.Channel.EndRegister(result);
        }
        
        private System.IAsyncResult OnBeginRegister(object[] inValues, System.AsyncCallback callback, object asyncState) {
            Client.RegisterService.Member member = ((Client.RegisterService.Member)(inValues[0]));
            return this.BeginRegister(member, callback, asyncState);
        }
        
        private object[] OnEndRegister(System.IAsyncResult result) {
            Client.RegisterService.Member retVal = this.EndRegister(result);
            return new object[] {
                    retVal};
        }
        ...
        public void RegisterAsync(Client.RegisterService.Member member) {
            this.RegisterAsync(member, null);
        }
        
        public void RegisterAsync(Client.RegisterService.Member member, object userState) {
